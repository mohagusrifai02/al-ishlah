...
export function SantriPutra(){
    const ref = useRef(null);
    const isInView = useInView(ref, { once: true, amount:0.6});
    const count = useCounter({ target:25, duration:3000, start:isInView});
...
export function SantriPutri(){
    const ref = useRef(null);
    const isInView = useInView(ref, { once: true, amount:0.6});
    const count = useCounter({ target:20, duration:3000, start:isInView});
...
export function PengurusPutra(){
    const ref = useRef(null);
    const isInView = useInView(ref, { once: true, amount:0.6});
    const count = useCounter({ target:10, duration:4000, start:isInView});
...
export function PengurusPutri(){
    const ref = useRef(null);
    const isInView = useInView(ref, { once: true, amount:0.6});
    const count = useCounter({ target:5, duration:5000, start:isInView});
